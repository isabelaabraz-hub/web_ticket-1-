...
- **SE (Senha Exames)**: Para atendimento  de exames/rápido
...
O projeto foi refatorado para utilizar uma arquitetura baseada em componentes funcionais:
...
### Emitir Senha
1. Clique em um dos botões: **Prioritária**, **Geral** ou **Exames**
...
Projeto desenvolvido para fins educacionais como parte do curso [ANALISE E DESENVOLVIMENTO DE SISTEMAS], Uninassau 2NA.
